    ...
    while(i<length):
        ...
        while(g <len(IDS)):
                ...
                try:
                    ...
                    member_mobile_data1=resp.json()["member_info"][1]['MobileNo']
                ...
                try:
                    ...
                    member_mobile_data2=resp.json()["member_info"][2]['MobileNo']
                ...
                try:
                    memeber_names_data33=resp.json()["member_info"][3]['FName']
                    member_email_data33=resp.json()["member_info"][3]['EmailId']
                    member_desg_data33=resp.json()["member_info"][3]['DesigName']
                    member_mobile_data33=resp.json()["member_info"][3]['MobileNo']
                    members_mobileno_lis.append(member_mobile_data33)

                    members_desg_lis.append(member_desg_data33)
                    members_name_lis.append(memeber_names_data33)
                    members_email_lis.append(member_email_data33)
                except:
                    pass
                   
                try:
                    memeber_names_data44=resp.json()["member_info"][4]['FName']
                    member_email_data44=resp.json()["member_info"][4]['EmailId']
                    member_desg_data44=resp.json()["member_info"][4]['DesigName']
                    member_mobile_data44=resp.json()["member_info"][4]['MobileNo']
                    members_mobileno_lis.append(member_mobile_data44)

                    members_desg_lis.append(member_desg_data44)
                    members_name_lis.append(memeber_names_data44)
                    members_email_lis.append(member_email_data44)
                except:
                    pass
                   
                try:
                    memeber_names_data55=resp.json()["member_info"][5]['FName']
                    member_email_data55=resp.json()["member_info"][5]['EmailId']
                    member_desg_data55=resp.json()["member_info"][5]['DesigName']
                    member_mobile_data55=resp.json()["member_info"][5]['MobileNo']
                    members_mobileno_lis.append(member_mobile_data55)

                    members_desg_lis.append(member_desg_data55)
                    members_name_lis.append(memeber_names_data55)
                    members_email_lis.append(member_email_data55)
